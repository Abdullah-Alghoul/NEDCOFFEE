...
#                                 AND struct_id = %s""" % (self.date_from, self.date_to, payslip_structure_ids[0])
            ...
            for payslip_id in self.cr.fetchall():
                ...
                res.append({'employee_name': payslip_obj.employee_id.name_related or False,
                            ...
                            'money': int(self.get_payslip_line(payslip_obj)['tl']) or False,
                            'tu': int(self.get_payslip_line(payslip_obj)['tu']) * (-1) or False,
                            'money_receipt': int(self.get_payslip_line(payslip_obj)['tl'] - self.get_payslip_line(payslip_obj)['tu']) or False,
                            })
