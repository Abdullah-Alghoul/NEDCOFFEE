...
class general_account_profit_loss(models.TransientModel):
...
#     date_end = fields.Date(string='Date end', default=time.strftime('%Y-%m-%d'))
    ...
    def print_report(self): 
        ...
        data['model'] = 'general.account.profit.loss'
        data['form'] = self.read([])[0]
        return {'type': 'ir.actions.report.xml', 'report_name': 'general_account_profit_loss' , 'datas': data}
